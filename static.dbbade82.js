  ...
  _createClass(Card, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        linkTo && linkTo.startsWith('/') ? _react2.default.createElement(
          LongCardLink,
          { to: linkTo, className: textAlign, colorWhite: colorWhite, image: image || false, background: background ? __webpack_require__(10)("./" + background) : '', gradient: gradient ? gradient : '' },
          image && textAlign == 'right' && _react2.default.createElement(
            ImageContainer,
            null,
            _react2.default.createElement('img', { src: __webpack_require__(10)("./" + image) })
          ),
          _react2.default.createElement(
            'div',
          ...
          LongCard,
          { href: linkTo, target: '_blank', className: textAlign, colorWhite: colorWhite, image: image || false, background: background ? __webpack_require__(10)("./" + background) : '', gradient: gradient ? gradient : '' },
          image && textAlign == 'right' && _react2.default.createElement(
            ImageContainer,
            null,
            _react2.default.createElement('img', { src: __webpack_require__(10)("./" + image) })
...
var Container = _styledComponents2.default.a(_templateObject, medium('grid-column-end: 3;'), medium('justify-content: flex-end'), function (props) {
...
var LongCard = _styledComponents2.default.a(_templateObject2, function (props) {
  return props.background && 'background-image: url(' + props.background + ');';
}, function (props) {
  return props.gradient && 'background-image:' + props.gradient + ';';
}, medium('padding: 30px 60px;'), medium('flex-direction: row;'));

var LongCardLink = (0, _styledComponents2.default)(_reactStatic.Link)(_templateObject2, function (props) {
  return props.background && 'background-image: url(' + props.background + ');';
}, function (props) {
  return props.gradient && 'background-image:' + props.gradient + ';';
}, medium('padding: 30px 60px;'), medium('flex-direction: row;'));

var ImageContainer = _styledComponents2.default.div(_templateObject3, medium('width: 50%;'), medium('height: 430px;'));
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        linkTo && linkTo.startsWith('/') ? _react2.default.createElement(
          SmallCardLink,
          { to: linkTo },
          _react2.default.createElement('img', { src: __webpack_require__(53)("./" + imageUrl + '.svg') }),
          _react2.default.createElement(
            'h1',
            null,
            title
...
var SmallCard = _styledComponents2.default.a(_templateObject, medium('padding: 30px 60px;'), medium('font-size: 46px;'));
var SmallCardLink = (0, _styledComponents2.default)(_reactStatic.Link)(_templateObject2, medium('padding: 30px 60px;'), medium('font-size: 46px;'));
...
var map = {
	...
	"./Discover/assets/discover1.svg": 54,
	"./Discover/assets/discover2.svg": 55,
	"./Discover/assets/discover3.svg": 56,
	"./Discover/assets/discover4.svg": 57,
	"./Discover/assets/discover5.svg": 58,
	"./Discover/assets/discover6.svg": 59,
	"./Discover/assets/discover7.png": 106,
	"./Discover/assets/quote1.png": 107,
	"./Discover/assets/quote2.png": 108,
	"./Discover/assets/unstoppable-org-background.png": 76,
	...
	"./Home/home-assets/home1.svg": 60,
	"./Home/home-assets/home2.svg": 61,
	"./Home/home-assets/home3.svg": 62,
	"./Home/home-assets/home4.svg": 63,
	"./Home/home-assets/home5.png": 110,
	"./Network/NetworkContent": 37,
	"./Network/NetworkContent.js": 37,
	"./Network/assets/network-background.png": 77,
	"./Network/assets/network1.svg": 64,
	"./Network/assets/network2.svg": 65,
	"./Network/assets/network3.svg": 66,
	"./Network/assets/network4.svg": 67,
	"./Page/Footer": 20,
	"./Page/Footer.js": 20,
	"./Page/MenuItem": 16,
	"./Page/MenuItem.js": 16,
	...
	"./Project/assets/community-background.png": 78,
	"./Project/assets/contribute-background1.png": 111,
	"./Project/assets/contribute1.svg": 68,
	"./Project/assets/contribute2.svg": 69,
	"./Project/assets/contribute3.svg": 70,
	"./Project/assets/governance-background.png": 79,
	"./Project/assets/governance1.svg": 71,
	"./Project/assets/governance2.svg": 72,
	"./Project/assets/governance3.png": 112,
	"./Project/assets/grants-background.png": 80,
	"./Project/assets/grants1.svg": 73,
	"./Project/assets/hero-background.png": 81,
	"./Project/assets/history-mobile.svg": 29,
	"./Project/assets/history.svg": 30,
	"./Project/assets/luis.png": 113,
	"./Project/assets/project1.svg": 74,
	"./Project/assets/project2.svg": 75,
...
var BlogPost = function BlogPost() {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(_LongCard2.default, { linkTo: 'https://app.aragon.org', background: 'Discover/assets/background-discover4.png', colorWhite: true, textAlign: 'center', title: 'Reclaim your freedom now', content: mudule2Content })
    )
  );
};
...
var _unstoppableOrgBackground = __webpack_require__(76);
...
var _heroBackground = __webpack_require__(81);
...
var _governanceBackground = __webpack_require__(79);
...
var _grantsBackground = __webpack_require__(80);
...
var _communityBackground = __webpack_require__(78);
...
var _networkBackground = __webpack_require__(77);
...
var _reactHotLoader = __webpack_require__(90);
...
var _reactStaticRoutes = __webpack_require__(92);
...
var _importCss2 = __webpack_require__(94);

var _importCss3 = _interopRequireDefault(_importCss2);

var _universalImport2 = __webpack_require__(95);
...
var _reactUniversalComponent = __webpack_require__(97);
...
var t_1 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Library/WebServer/Documents/website/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 82)), (0, _importCss3.default)('src/pages/Discover', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_2 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Library/WebServer/Documents/website/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 83)), (0, _importCss3.default)('src/pages/Project', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_3 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Library/WebServer/Documents/website/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 84)), (0, _importCss3.default)('src/pages/Governance', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_4 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Library/WebServer/Documents/website/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 85)), (0, _importCss3.default)('src/pages/Grants', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_5 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Library/WebServer/Documents/website/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 86)), (0, _importCss3.default)('src/pages/Contribute', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_6 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Library/WebServer/Documents/website/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 87)), (0, _importCss3.default)('src/pages/Network', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
//# sourceMappingURL=static.dbbade82.js.map